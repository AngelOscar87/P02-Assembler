...
Si aún no tiene una cuenta en GitHub, ve a GitHub y crea una cuenta.
...
Configurar Git y Visual Studio Code:

Si no lo tiene instalado, descarga e instala Git en su computadora.
...
Crear un archivo .py en Visual Studio Code
...
Verificar la subida del proyecto:
